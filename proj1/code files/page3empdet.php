...
$sql="CREATE TABLE IF NOT EXISTS `present_employment` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `position` VARCHAR(255) NOT NULL , `status` VARCHAR(255) NOT NULL , `dol` DATE NOT NULL , `organization` VARCHAR(255) NOT NULL , `doj` DATE  NOT NULL , `duration` VARCHAR(255) NOT NULL  , PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

$sql="CREATE TABLE IF NOT EXISTS `history` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `position` VARCHAR(255) NOT NULL , `institute` VARCHAR(255) NOT NULL , `doj` DATE NOT NULL , `dol` DATE NOT NULL , `duration` VARCHAR(255) NOT NULL ,`teach_exp` VARCHAR(255) NOT NULL, PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);


$sql="CREATE TABLE IF NOT EXISTS`teaching` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `position` VARCHAR(255) NOT NULL, `employer` VARCHAR(255) NOT NULL , `course` VARCHAR(255) NOT NULL , `ug_pg` VARCHAR(255) NOT NULL ,`number` VARCHAR(255) NOT NULL , `doj` DATE NOT NULL , `dol` DATE NOT NULL , `duration` VARCHAR(255) NOT NULL , PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

$sql="CREATE TABLE IF NOT EXISTS`research` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `position` VARCHAR(255) NOT NULL , `institute` VARCHAR(255) NOT NULL , `supervisor` VARCHAR(255) NOT NULL ,`doj` DATE NOT NULL , `dol` DATE NOT NULL , `duration` VARCHAR(255) NOT NULL , PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

$sql="CREATE TABLE IF NOT EXISTS`industry` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `organization` VARCHAR(255) NOT NULL , `profile` VARCHAR(255) NOT NULL ,`doj` DATE NOT NULL , `dol` DATE NOT NULL , `duration` VARCHAR(255) NOT NULL, PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

$sql="CREATE TABLE IF NOT EXISTS`area` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `specialization` VARCHAR(500) NOT NULL ,`area_of_research` VARCHAR(500) NOT NULL,PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

?>
<?php
if(isset($_POST['pres_emp_position'], $_POST['pres_status'], $_POST['pres_emp_dol'], $_POST['pres_emp_employer'], $_POST['pres_emp_doj'], $_POST['pres_emp_duration'])) {
    ...
    $dol =date('Y-m-d', strtotime($_POST['pres_emp_dol']));
    $doj=date('Y-m-d', strtotime($_POST['pres_emp_doj']));
    // $date_of_award = date('Y-m-d', strtotime($_POST['doa_phd']));
    // $date_of_defence = date('Y-m-d', strtotime($_POST['dod_phd']));
    

    // Prepare and execute query
    $sql = "INSERT INTO `present_employment` (`position`, `status`, `dol`, `organization`, `doj`, `duration`)
            VALUES ('$position', '$status', '$dol', '$organization', '$doj', '$duration')";
...
?>
<?php
if(isset($_POST['position'], $_POST['employer'], $_POST['doj'], $_POST['dol'], $_POST['exp_duration'], $_POST['teach_exp'])) {
    ...
    // Prepare and execute query
    foreach ($employers as $key => $author) {
        $position = $positions[$key];
        $employer = $employers[$key];
        $duration = $durations[$key];
        
        $doj = date('Y-m-d', strtotime($dojs[$key])); // Convert date format
        $dol = date('Y-m-d', strtotime($dols[$key])); // Convert date format

        $sql = "INSERT INTO `history` (`position`, `institute`, `doj`, `dol`, `duration`, `teach_exp`)
                VALUES ('$position', '$employer', '$doj', '$dol', '$duration', '$teach_exp')";
...
?>
<?php
if(isset($_POST['te_position'], $_POST['te_employer'], $_POST['te_doj'], $_POST['te_dol'], $_POST['te_duration'], $_POST['te_ug_pg'],$_POST['te_course'],$_POST['te_no_stu'])) {
    $positions = $_POST['te_position'];
    $employers = $_POST['te_employer'];
    $dojs = $_POST['te_doj'];
    $dols = $_POST['te_dol'];
    $durations = $_POST['te_duration'];
    $courses = $_POST['te_course'];
    $studs= $_POST['te_no_stu'];
    $ugs= $_POST['te_ug_pg'];
    ...
    foreach ($employers as $key => $author) {
        ...
        $sql = "INSERT INTO `teaching` (`position`, `employer`, `course`, `ug_pg`,`number`,`doj`,`dol`, `duration`)
                VALUES ('$position', '$employer', '$course', '$ug', '$stud', '$doj','$dol','$duration')";
...
?>
<?php
if(isset($_POST['r_exp_position'], $_POST['r_exp_institute'], $_POST['r_exp_doj'], $_POST['r_exp_dol'], $_POST['r_exp_duration'], $_POST['r_exp_supervisor'])) {
    $positions = $_POST['r_exp_position'];
    $employers = $_POST['r_exp_institute'];
    ...
    foreach ($employers as $key => $author) {
        ...
        $sql = "INSERT INTO `research` (`position`, `institute`, `supervisor`, `doj`,`dol`,`duration`)
                VALUES ('$position', '$employer', '$supervisor', '$doj','$dol','$duration')";
...
?>
<?php
if(isset($_POST['org'], $_POST['work'], $_POST['ind_doj'], $_POST['ind_dol'], $_POST['period'], $_POST['r_exp_supervisor'])) {
    $positions = $_POST['org'];
    $employers = $_POST['work'];
    $dojs = $_POST['ind_doj'];
    $dols = $_POST['ind_dol'];
    ...
    foreach ($employers as $key => $author) {
        ...
        $sql = "INSERT INTO `industry` (`organization`, `profile`, `doj`, `dol`,`duration`)
                VALUES ('$position', '$employer', '$doj','$dol','$duration')";
...
?>
<?php
if(isset($_POST['area_spl'], $_POST['area_rese'])) {
    $spec = $_POST['area_spl'];
    $area_of_res = $_POST['area_rese'];


    // Prepare and execute query
    $sql = "INSERT INTO `area` (`specialization`, `area_of_research`)
            VALUES ('$spec', '$area_of_res')";
...
header("location: page4publication.php");
            ...
            <fieldset>
                 ...
                 <legend>
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <a href="logout.php" class="btn btn-sm btn-success  pull-right" style = "background-color: rgb(202, 39, 72);">Logout</a>
                    </div>
                  </div>
...
<h4 style="text-align:center; font-weight: bold; color: #060606;">3. Employment Details</h4>
...
<div class="row">
    <div class="col-md-12">
      ...
      <div class="panel-heading" style="color: #252527; background-color: #f99090;" >(A) Present Employment</div>
        <div class="panel-body">
          
          <span class="col-md-2 control-label" for="pres_emp_position">Position</span>  
          <div class="col-md-4">
          <input id="pres_emp_position" value="2448 Sheridan Gateway" name="pres_emp_position" type="text" placeholder="Position" class="form-control input-md" autofocus="" required="">
          </div>
...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-success">
      <div class="panel-heading" style="color: #252527; background-color: #f99090;">(B) Employment History (After PhD, Starting with Latest)  </strong></font>&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-sm btn-danger" id="add_more_exp" style = "background-color:#4dad32">Add Details</button></div>
      <div class="panel-body">
...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-success">
    <div class="panel-heading" style="color: #252527; background-color: #f99090;">(C) Teaching Experience (After PhD)&nbsp;&nbsp;&nbsp;<button class="btn btn-sm btn-danger" id="add_more_t_exp" style = "background-color:#4dad32">Add Details</button></div>
      <div class="panel-body">
        <table class="table table-bordered">
            <tbody id="t_exp">
...
<div class="col-md-12">
  <div class="panel panel-success">
  <div class="panel-heading" style="color: #252527; background-color: #f99090;">(D) Research Experience (Post PhD, including Post Doctoral)&nbsp;&nbsp;&nbsp;<button class="btn btn-sm btn-danger" id="add_more_r_exp" style = "background-color:#4dad32">Add Details</button></div>
    <div class="panel-body">
      <table class="table table-bordered">
          <tbody id="r_exp">
...
<div class="row">
    <div class="col-md-12">
      <div class="panel panel-success">
      <div class="panel-heading" style="color: #252527; background-color: #f99090;">(E) Industrial Experience &nbsp;&nbsp;&nbsp;<button class="btn btn-sm btn-danger" id="add_more_ind_exp" style = "background-color:#4dad32">Add Details</button></div>
        <div class="panel-body">
...
<h4 style="text-align:center; font-weight: bold; color: #060606;">4. Area(s) of Specialization and Current Area(s) of Research</h4>
 <div class="row">
  <div class="col-md-6">
    <div class="panel panel-success">
      ...
      <div class="panel-body">
        ...
        <textarea style="height:150px" placeholder="Areas of specialization" class="form-control input-md" name="area_spl" maxlength="500" required="">Nesciunt sunt quos impedit quidem quas architecto.</textarea>
      </div>
    </div>
  </div>
...
<div class="form-group">
  ...
  <div class="col-md-1">
    <a href="page2edu.html" class="btn btn-primary pull-left"><i class="glyphicon glyphicon-fast-backward"></i></a>
  </div>
