...
$sql="CREATE TABLE IF NOT EXISTS `publications` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `summary_journal_inter` VARCHAR(255) NOT NULL , `summary_journal` VARCHAR(255) NOT NULL , `summary_conf_inter` VARCHAR(255) NOT NULL , `summary_conf_national` VARCHAR(255) NOT NULL , `patent_publish` VARCHAR(255)  NOT NULL , `summary_book` VARCHAR(255) NOT NULL , `summary_book_chapter` VARCHAR(255) NOT NULL  , PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

$sql="CREATE TABLE IF NOT EXISTS `best10` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `author` VARCHAR(255) NOT NULL , `title` VARCHAR(255) NOT NULL , `name` VARCHAR(255) NOT NULL , `year` VARCHAR(255) NOT NULL , `impact` VARCHAR(255) NOT NULL , `doi` DATE NOT NULL , `status` VARCHAR(255) NOT NULL  , PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);


$sql="CREATE TABLE IF NOT EXISTS`patents` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `inventor` VARCHAR(255) NOT NULL , `title` VARCHAR(255) NOT NULL , `country` VARCHAR(255) NOT NULL , `number` VARCHAR(255) NOT NULL , `filing_date` DATE NOT NULL , `publication_date` DATE NOT NULL , `status` VARCHAR(255) NOT NULL , PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

$sql="CREATE TABLE IF NOT EXISTS`books` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `author` VARCHAR(255) NOT NULL , `title` VARCHAR(255) NOT NULL , `year` VARCHAR(255) NOT NULL , `ISBN` VARCHAR(255) NOT NULL , PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

$sql="CREATE TABLE IF NOT EXISTS`chapters` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `author` VARCHAR(255) NOT NULL , `title` VARCHAR(255) NOT NULL , `year` VARCHAR(255) NOT NULL , `ISBN` VARCHAR(255) NOT NULL , PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

$sql="CREATE TABLE IF NOT EXISTS`URL` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `url` VARCHAR(355) NOT NULL ,PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

?>
<?php
if(isset($_POST['summary_journal_inter'], $_POST['summary_journal'], $_POST['summary_conf_inter'], $_POST['summary_conf_national'], $_POST['patent_publish'], $_POST['summary_book'], $_POST['summary_book_chapter'])) {
    $summary_int = $_POST['summary_journal_inter'];
    $summary = $_POST['summary_journal'];
    $conf_inter = $_POST['summary_conf_inter'];
    $conf_national = $_POST['summary_conf_national'];
    $patent = $_POST['patent_publish'];
    $book = $_POST['summary_book'];
    $chapter = $_POST['summary_book_chapter'];
    // $date_of_award = date('Y-m-d', strtotime($_POST['doa_phd']));
    // $date_of_defence = date('Y-m-d', strtotime($_POST['dod_phd']));
    

    // Prepare and execute query
    $sql = "INSERT INTO `publications` (`summary_journal_inter`, `summary_journal`, `summary_conf_inter`, `summary_conf_national`, `patent_publish`, `summary_book`, `summary_book_chapter`)
            VALUES ('$summary_int', '$summary', '$conf_inter', '$conf_national', '$patent', '$book', '$chapter')";
...
<?php
if(isset($_POST['author'], $_POST['title'], $_POST['journal'], $_POST['year'], $_POST['impact'], $_POST['doi'], $_POST['status'])) {
    ...
    foreach ($authors as $key => $author) {
        ...
        $impact = $impacts[$key];
        $year = $years[$key];
        $doi = date('Y-m-d', strtotime($dois[$key])); // Convert date format

        $sql = "INSERT INTO `best10` (`author`, `title`, `name`, `year`, `impact`, `doi`, `status`)
                VALUES ('$author', '$title', '$journal', '$year', '$impact', '$doi', '$status[$key]')";
...
<?php
if(isset($_POST['pauthor'], $_POST['ptitle'], $_POST['p_country'], $_POST['p_number'], $_POST['pyear_filed'], $_POST['pyear_published'], $_POST['pyear_issued'])) {
    $author = $_POST['pauthor'];
    $title = $_POST['ptitle'];
    $country = $_POST['p_country'];
    $number = $_POST['p_number'];
    $filed = $_POST['pyear_filed'];
    $published = $_POST['pyear_published'];
    $issued = $_POST['pyear_issued'];
    ...
    $sql = "INSERT INTO `patents` (`inventor`, `title`, `country`, `number`, `filing_date`, `publication_date`, `status`)
            VALUES ('$author[$key]', '$title[$key]', '$country[$key]', '$number[$key]', '$filed[$key]', '$published[$key]', '$issued[$key]')";
            if(mysqli_query($conn, $sql)) {
                echo "Record inserted successfully";
            } else {
                echo "Error: " . $sql . "<br>" . mysqli_error($conn);
...
?>
<?php
if(isset($_POST['bauthor'], $_POST['btitle'], $_POST['byear'], $_POST['bisbn'])) {
    ...
    // Prepare and execute query
    foreach ($author as $key => $value) {
    $sql = "INSERT INTO `books` (`author`, `title`, `year`, `ISBN`)
            VALUES ('$author[$key]', '$title[$key]', '$year[$key]', '$isbn[$key]')";
            if(mysqli_query($conn, $sql)) {
                echo "Record inserted successfully";
            } else {
                echo "Error: " . $sql . "<br>" . mysqli_error($conn);
...
?>
<?php
if(isset($_POST['bc_author'], $_POST['bc_title'], $_POST['bc_year'], $_POST['bc_isbn'])) {
    $author = $_POST['bc_author'];
    ...
    // Prepare and execute query
    foreach ($author as $key => $value) {
        $sql = "INSERT INTO `chapters` (`author`, `title`, `year`, `ISBN`)
        VALUES ('$value', '$title[$key]', '$year[$key]', '$isbn[$key]')";
...
<div class="container-fluid" style="background-color: cornsilk; margin-bottom: 10px;">
	<div class="container">
        <div class="row" style="margin-bottom:10px; ">
            ...
            text-align: center;
           "class="blink_me" class="blink_me">Application for Faculty Position</h3>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-8 well">
            ...
            <h4 style="text-align:center; font-weight: bold;color: #252527;">5. Summary of Publications *</h4>
            <div class="row">
              <div class="col-md-12">
           ...
           <h4 style="text-align:center; font-weight: bold; color: #252527;">6. List of 10 Best Publications (Journal/Conference)</h4>
           ...
           <div class="container-fluid table-responsive">
              <div class="row">
               ...
               <div class="panel panel-success">
                <div class="panel-heading" style="color: #252527; background-color: #f99090;">List of 10 Best Publications (Journal/Conference) &nbsp;&nbsp;&nbsp;
                  <button class="btn btn-sm btn-danger" id="add_more_jour " style="background-color: #4dad32;">Add Details</button>
                </div>
           ...
           <!-- Patent Text -->
             ...
             <div class="container-fluid table-responsive">
              ...
              <h4 style="text-align:center; font-weight: bold; color: #6739bb; color: #252527;">7. List of  Patent(s), Book(s), Book Chapter(s)</h4>
             <div class="row">

           <div class="panel panel-success">
            <div class="panel-heading" style="color: #252527; background-color: #f99090; color: #252527;">(A) Patent(s)&nbsp;&nbsp;&nbsp;<button class="btn btn-sm btn-danger" id="add_more_patent" style="background-color: #4dad32;">Add Details</button>  </div>
            <table class="table table-bordered">
                <tbody id="patent">
            ...
            <!-- Book Text -->
             ...
             <div class="panel panel-success">
             <div class="panel-heading" style="color: #252527; background-color: #f99090; color: #252527;">(B) Book(s) &nbsp;&nbsp;&nbsp;<button class="btn btn-sm btn-danger" id="add_more_book" style="background-color: #4dad32;">Add Details</button></div>
            ...
            <!-- Book chapter Text -->
             ...
             <div class="panel panel-success">
             <div class="panel-heading" style="color: #252527; background-color: #f99090; color: #252527;">(C) Book Chapter(s)&nbsp;&nbsp;&nbsp;<button class="btn btn-sm btn-danger" id="add_more_book_chapter" style="background-color: #4dad32;">Add Details</button></div>
            ...
            <h4 style="text-align:center; font-weight: bold; color: #252527;">8. Google Scholar Link *</h4>
            <div class="row">
            <div class="col-md-12">
            <div class="panel panel-success">
            <div class="panel-heading" style="color: #252527; background-color: #f99090;">URL</div>
            <div class="panel-body">
...
<div class="form-group">
  ...
  <div class="col-md-1">
    <a href="page3empdet.php" class="btn btn-primary pull-left"><i class="glyphicon glyphicon-fast-backward"></i></a>
  </div>
