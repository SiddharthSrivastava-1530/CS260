...
$sql="CREATE TABLE IF NOT EXISTS `declaration_status` (`applicant_id` INT NOT NULL AUTO_INCREMENT , `declare_status` VARCHAR(255) NOT NULL   , PRIMARY KEY (`applicant_id`)) ENGINE = InnoDB";
mysqli_query($conn,$sql);

?>
<?php
if(isset($_POST['decl_status'])) {
    $status = $_POST['decl_status'];

    

    // Prepare and execute query

        $sql = "INSERT INTO `declaration_status` (`declare_status`)
                VALUES ('$status')";
...
<div class="col-md-12">
      ...
      <div class="panel-heading" style="color: #252527; background-color: #f99090;"">23. Final Declaration *</div>
...
<div class="col-md-12">
  ...
  <a href="page8refandupl.php" class="btn btn-primary pull-left"><i class="glyphicon glyphicon-fast-backward"></i></a>
